        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#why-wangoes" className="text-gray-400 hover:text-red-500 transition-colors">Why Us</a></li>
              <li><a href="#success-stories" className="text-gray-400 hover:text-red-500 transition-colors">Case Studies</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
                ...
                <li className="flex space-x-4 pt-2">
                    ...
                    <a href="#" className="hover:text-red-500"><svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22.2 0H1.8C.8 0 0 .8 0 1.8v20.4C0 23.2.8 24 1.8 24h11.6v-9.1H9.9v-3.6h3.5V8.4c0-3.5 2.1-5.4 5.2-5.4 1.5 0 2.8.1 3.2.2v3.2h-1.9c-1.7 0-2 .8-2 2v2.6h3.6l-.5 3.6h-3.1V24h6.2c1 0 1.8-.8 1.8-1.8V1.8C24 .8 23.2 0 22.2 0z"/></svg></a>
