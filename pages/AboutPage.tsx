        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center scroll-animate fade-in-up">
            ...
            <p className="mt-4 text-lg md:text-xl text-gray-300">
              Wangoes Technologies is a premier custom software development and AI automation company, founded in Indore, India. We are dedicated to building intelligent solutions that empower businesses to scale and innovate.
            </p>
          </div>
          ...
          <div className="mt-16 max-w-5xl mx-auto grid md:grid-cols-2 gap-12 text-left">
            ...
            <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700 scroll-animate fade-in-up" style={{ transitionDelay: '400ms' }}>
