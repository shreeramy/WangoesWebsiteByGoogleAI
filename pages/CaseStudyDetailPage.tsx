      ...
      <div className="bg-slate-900 pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                <img src={story.imageUrl} alt={story.title} className="w-full h-auto object-cover rounded-xl shadow-2xl shadow-slate-950/50" />
                
                <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center bg-slate-800/50 p-6 rounded-lg border border-slate-700">
                    <div>
